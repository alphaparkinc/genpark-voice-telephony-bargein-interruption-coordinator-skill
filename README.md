# genpark-voice-telephony-bargein-interruption-coordinator-skill
...
**genpark-voice-telephony-bargein-interruption-coordinator-skill** is a deterministic, zero-dependency Python skill engineered for autonomous conversational voice agents, telephony IVR navigation, and real-time interruption arbitration.

> **Executive Capability**: Full-duplex telephony voice interruption coordinator (Bland AI / Retell)
...
result = client.coordinate_bargein()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-voice-telephony-bargein-interruption-coordinator-skill": {
      "command": "python",
      "args": ["/path/to/genpark-voice-telephony-bargein-interruption-coordinator-skill/mcp_server.py"]
    }
  }
}
```
